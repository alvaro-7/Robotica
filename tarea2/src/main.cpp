...
/** \mainpage RoboComp::tarea2
 *
 * \section intro_sec Introduction
 *
 * The tarea2 component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/tarea2 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class tarea2 : public RoboComp::Application
{
public:
	tarea2 (QString prfx, bool startup_check) { prefix = prfx.toStdString(); this->startup_check_flag=startup_check; }
private:
	void initialize();
	std::string prefix;
	TuplePrx tprx;
...
int ::tarea2::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
...
int main(int argc, char* argv[])
{
	...
	::tarea2 app(prefix, startup_check_flag);
